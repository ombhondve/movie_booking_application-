...
function seatLayout(totalSeats, availableSeats) {
  const taken = totalSeats - availableSeats;
...
export default function ShowDetail() {
  ...
  const layout = useMemo(() => {
    ...
    return seatLayout(selectedShow.totalSeats, selectedShow.availableSeats);
  }, [selectedShow]);
